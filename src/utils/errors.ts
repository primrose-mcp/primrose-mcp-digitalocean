/**
 * Error Handling Utilities for DigitalOcean MCP Server
 */

/**
 * Base DigitalOcean API error
 */
export class DigitalOceanApiError extends Error {
  ...
  constructor(message: string, statusCode?: number, code?: string, retryable = false) {
    ...
    this.code = code || 'DIGITALOCEAN_ERROR';
 ...
 */
export class RateLimitError extends DigitalOceanApiError {
 ...
 */
export class AuthenticationError extends DigitalOceanApiError {
 ...
 * Not found error
 */
export class NotFoundError extends DigitalOceanApiError {
 ...
 * Validation error
 */
export class ValidationError extends DigitalOceanApiError {
